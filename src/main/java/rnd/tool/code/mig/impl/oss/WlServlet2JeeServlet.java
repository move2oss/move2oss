...
public class WlServlet2JeeServlet extends AbstractMigrator<CompilationUnit> {

	public WlServlet2JeeServlet() {
		this.classPar = new CompilationUnitClassParser();
		this.classPro = new CompilationUnitClassProcessor(MappingProvider.getMapping("weblogic/web"));
